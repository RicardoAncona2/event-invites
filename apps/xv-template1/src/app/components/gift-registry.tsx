...
import { Box, Typography, Grid, Card, CardContent, CardActionArea, Link, useTheme } from "@mui/material"
    ...
    <Box sx={{ textAlign: "center", mt: 6 }}>
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
          Si deseas hacerme un regalo, he creado estas listas de regalos para tu conveniencia
        </Typography>
      </Box>

      <Grid container spacing={3} justifyContent="center">
        {giftRegistries.map((registry, index) => (
          <Grid item xs={12} sm={6} md={4} key={registry.store}>
            <MotionCard
            ...
            >
              ...
              >
                <CardContent>
                  <Box sx={{ color: "primary.main", mb: 2 }}>{registry.icon}</Box>
